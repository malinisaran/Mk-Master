    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
          {/* Vision Section */}
          <div className="mt-10 mb-16 sm:mb-20 md:mb-24">
            <motion.div
            ...
            >
              ...
              <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
              {visionPoints.map((point, index) => (
                ...
                >
                  <div className="flex-shrink-0 mt-1 p-2 sm:p-2.5 rounded-lg bg-[#04BDF120]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-start">
            ...
            >
              <div>
                <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 leading-tight">
              ...
              <div className="space-y-4 sm:space-y-5 md:space-y-6">
                {missionCommitments.map((commitment, index) => (
                  <div key={index} className="flex items-start space-x-3 sm:space-x-4 md:space-x-5">
                    <div className="flex-shrink-0 mt-1 p-1.5 sm:p-2 md:p-2.5 rounded-lg bg-[#04BDF120]">
            ...
            >
              ...
              <div className="relative flex-1 w-full lg:w-auto flex flex-col justify-between h-[250px] sm:h-[350px] md:h-[400px] lg:h-[450px] xl:h-[500px] 2xl:h-[550px]">
                    ...
                    <div className="relative h-full flex flex-col justify-between">
                      <div>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2 md:h-2.5 mb-1 sm:mb-1.5 md:mb-2">
                          <div className="h-1.5 sm:h-2 md:h-2.5 rounded-full w-[89.89%] bg-[#04BDF1]"></div>
                        </div>
                ...
                <div className="relative text-white p-3 sm:p-4 md:p-5 lg:p-6 rounded-lg shadow-xl flex-shrink-0 h-[80px] sm:h-[100px] md:h-[110px] lg:h-[120px] xl:h-[130px] 2xl:h-[140px] flex flex-col justify-center bg-[#04BDF1]">
